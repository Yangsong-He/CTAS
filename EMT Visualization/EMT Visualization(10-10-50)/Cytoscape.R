#设置工作空间
setwd("C:/Users/a/Desktop/data/EMT_data+code/data+code/Network Construct/EMT Visualization")

## EMT dataset
### E_M whole network
AM_E_M <- read.csv('AdjacentMatrix_E_M.csv',header = F)
NodeID_EMT <- read.csv('NodeID_E_M.csv',header = F)
...
write.table(C_E_M, file="Cytoscape_E_M_Network.txt", quote=F, row.names=F, col.names=F, sep="\t")
